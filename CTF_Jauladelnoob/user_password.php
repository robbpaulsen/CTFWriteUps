...
<div class='hide js-show'>    <form method="get" action="index.php" class="disableAjax">
    <input type="hidden" name="db" value=""><input type="hidden" name="table" value=""><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="7630317a4e235f532d296e7e2b40613a">
    ...
    <form method="post" id="login_form" action="index.php" name="login_form" class="disableAjax hide login js-show">
        <fieldset>
        <legend><input type="hidden" name="set_session" value="uofu6jb1bs0goh23p6egc2qvut">Log in<a href="doc/html/index.html" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a></legend><div class="item">
            ...
            </div>    <input type="hidden" name="server" value="1"></fieldset><fieldset class="tblFooters"><input class="btn btn-primary" value="Go" type="submit" id="input_go"><input type="hidden" name="target" value="user_password.php"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="7630317a4e235f532d296e7e2b40613a"></fieldset>
    </form></div>
